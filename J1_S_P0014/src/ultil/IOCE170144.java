...
public class IOCE170144 {
     ...
     * @param iMsg Used to announce the input sentence
     * @param iErr Used to report an error when the condition is wrong
     * @param t The minimum length of the input string
     * @return a String representing the user input
     */
    public static String getUserInfo(String iMsg, String iErr, int t) {
        while (true) {
            try {
                System.out.print(iMsg);
                String s = sc.nextLine();
                // Check whether the string is less than the given integer
                if (s.length() < t || s.contains(" ")) {
                    throw new Exception();
                }
                return s;
                // Print an error if the input is wrong
     ...
     * @return a String representing the user input
     */
    public static String checkUserLogin(String iMsg, String iErr, int t) {
        while (true) {
            try {
                System.out.print(iMsg);
                String s = sc.nextLine();
